...
public class DropDown_DeselectValues {
	...
	public static void main(String[] args) {
		...
		try {
			...
			for (String selectedOption : actualSelectedOptions) {
				selectCars.deselectByVisibleText(selectedOption); // deselectByVisibleText() will deselect the options matching the text from the list.
			}
