...
public class Dropdown_SelectByVisibleText {
	...
	public static void main(String[] args) {
		System.out.println("Program to select option from dropdown by visible text");
		...
		try {
			...
			selectCars.selectByVisibleText("Audi");	// selectByVisibleText() will select the option with text 'Audi'.
